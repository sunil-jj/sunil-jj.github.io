...
import {EmailIcon,PhoneIcon} from "@chakra-ui/icons"
 import social from "../Image/socialmedia.jpg"
...
export default function Contact() {
    ...
    <Flex bg="GrayText" borderRadius="2xl" flexWrap="wrap" w="100%" m="auto" justify="space-between" mt="8%" id="contact-card">
            ...
            <Image src={social} w="100%" borderRadius="2xl" h={["150px","250px","400px"]}></Image>
            </Box>
        ...
        <Box w="50%"  p="2%" textAlign="left" alignItems="cneter"> 
            ...
            <Flex  id="contact-phone" gap="2%" alignItems="center" justifyContent="left" w="100%" mb="5%" >
                    ...
                    <Text fontSize={["sm","md","xl"]}> +918722488078</Text>
                ...
                <Flex id="contact-email"  gap="2%" alignItems="center" justifyContent="left" w="100%" mb="5%" >
                    ...
                    <Text fontSize={["sm","sm","xl"]} > sunilamaranth@gmail.com</Text>

            </Flex>

            <Flex w="40%" justify="left" gap="5%">
                
            <Link href="https://github.com/Sunil-JJ" isExternal><Box as="Button" borderRadius="xl" w ={["40px","60px","80px"]} h={["20px","30px","40px"]} fontSize={["7px","10px","17px"]}  _hover={{bg:"green.300",color:"black"}} bg = "tomato" color="white" id="contact-github">Github </Box></Link>
            <Link href="https://www.linkedin.com/in/sunil-amaranth-91a5b6189/" isExternal><Box as="Button" borderRadius="xl" w ={["40px","60px","80px"]} h={["20px","30px","40px"]} fontSize={["7px","10px","17px"]}  _hover={{bg:"green.300",color:"black"}} bg = "tomato" color="white" id="contact-linkedin">Linkedin</Box></Link>
