...
import mypic from "../Image/CaptureMYPIC.png"
export default function Home() {
    return <Box  id="home"  p="6%" w ="100%" >
        ...
        <Box borderRadius="15%" w="15%" m="auto" p="1%" textAlign="left">
            <Image className="home-img" id="profile-img" src={mypic} borderRadius="15%" w="100%"></Image>
        </Box>
        <Box  textAlign="left">
        <Box  w="80%"  id="user-detail-intro" m="auto">
        <Text fontSize={["xl","2xl","4xl"]} >Hi ! I am </Text>
        <Heading fontSize={["2xl","3xl","5xl"]} color="tomato" _hover={{color:"gray"}}>Sunil Amarnath </Heading>
